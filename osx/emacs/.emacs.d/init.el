...
(add-to-list 'default-frame-alist '(height . 24))                 ;; Window Height
...
;; NOTE: Make sure to config a GitHub token before using this package!
(use-package forge)
...
(defun efs/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 1.2)
                  ...
                  (org-level-7 . 1.1)
                  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :font "JetBrainsMono Nerd Font Mono" :weight 'regular :height (cdr face)))
